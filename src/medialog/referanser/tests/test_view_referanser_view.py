...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_referanser_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='referanser-view'
        )
        self.assertTrue(view.__name__ == 'referanser-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in referanser-view'
        # )

    def test_referanser_view_not_matching_interface(self):
